...
function page_title(){ return 'Service Page - Ytronic'; }
...
<div class="container-fluid pb-5 mt-5 mt-lg-0 pt-5 pt-lg-0">
	<div class="container py-5">
		<div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 800px;">
			<h5 class="fw-bold text-primary text-uppercase">Services Page</h5>
			<h1 class="mb-0">Services Page Example Content</h1>
		</div>
		<div class="row g-5">
